...
class App {
  ...
  public static void main(String... args) {
    boolean onlyDigit = Strings.containsOnlyDigit("464782456");
    System.out.println("onlyDigit = " + onlyDigit);

    boolean digitStream = Strings.containsOnlyDigitStream("4647WWW82456");
    System.out.println("digitStream = " + digitStream);
  }
}