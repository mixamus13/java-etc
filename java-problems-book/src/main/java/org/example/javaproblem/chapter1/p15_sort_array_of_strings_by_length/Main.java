package org.example.javaproblem.chapter1.p15_sort_array_of_strings_by_length;
...
public class Main {
    ...
    private static String[] strs = {"one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"};
