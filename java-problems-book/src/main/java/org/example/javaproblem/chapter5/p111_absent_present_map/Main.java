package org.example.javaproblem.chapter5.p111_absent_present_map;
...
public class Main {
    ...
    public static void main(String... args) {
        ...
        String mySqlVersion3 = map4.merge("mysql", "13.0 ", jdbcUrl4);
        System.out.println("MySQL versions (added 9.0): " + mySqlVersion3);
